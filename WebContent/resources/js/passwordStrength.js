$(document).ready(function() 
{
	...
	$("#newPasswordAccSett").bind("keyup", checkVal);
...
function outputResult(thisId)
{
	...
	{
		complexity.html(minPasswordLength+ " charachters-Too short!").removeClass("strong stronger strongest").addClass("weak");
	}
	else if (score<50)
	{
