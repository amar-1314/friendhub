...
<tiles:insertDefinition name="work">
 ...
 <a href="${Editurl}">Edit Profile</a>
			...
			<div>
				...
				<a href="${home}" class="newsFeed">News Feed</a><br><spring:url value="/chat" var="chat" htmlEscape="true" />
		...
		<div id = "workContactsBlock">
			
				<c:forEach items="${workFriendList}" var="workFriendList" varStatus="status">
					<div>
						<div style="float: left; width: 7%; height: 200px;">
							<img id="profilePicture" alt="Profile Picture"
								src="${workFriendList.friendUserID.profilePicutreBase64String}">
						</div>

					</div>
							
					<div style="width: 40%; height: 200px; float: left;">
						<label>${workFriendList.friendUserID.firstName}</label>
						<br>
						<img src="resources/images/online22.svg" style="width: 30px; height: 30px">
					</div>
					</c:forEach>
